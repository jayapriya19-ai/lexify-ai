      ...
      <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0e7b7f] pr-10"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#0e7b7f] text-white py-2 px-4 rounded-md hover:bg-[#0a6266] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <button
              ...
              className="text-[#0e7b7f] hover:text-[#0a6266] font-medium"
            >
